          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: TextButton(onPressed: () {}, child: const Text('Quên mật khẩu?', style: TextStyle(color: Color(0xFF4A7DFF), fontWeight: FontWeight.w600))),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF4A7DFF), elevation: 0, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16))),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: const Text('Đăng ký ngay', style: TextStyle(color: Color(0xFF4A7DFF), fontWeight: FontWeight.bold)),
                  ),
                ],
              )
            ],
