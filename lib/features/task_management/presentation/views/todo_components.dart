    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          leading: Icon(task.isCompleted ? Icons.check_circle : Icons.circle_outlined, color: task.isCompleted ? const Color(0xFF4A7DFF) : Colors.grey),
        );
      },
    );
  }
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            padding: const EdgeInsets.all(8),
                            decoration: const BoxDecoration(color: Color(0xFF4A7DFF), shape: BoxShape.circle),
